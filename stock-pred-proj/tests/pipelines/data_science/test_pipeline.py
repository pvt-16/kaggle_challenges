...
from stock_pred_proj.pipelines.data_science import create_pipeline as create_ds_pipeline
from stock_pred_proj.pipelines.data_science.nodes import split_data
